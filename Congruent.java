...
public class Congruent {
  public static void main (String [] args) {
    ...
    // Accepting first triangle from the user. 
    System.out.println ("Enter first triangle parameters");
    ...
    // Accepting second triangle from the user.
    System.out.println ("Enter second triangle parameters"); 
    ...
    // Calculating the length of the triangules' edges.
    ...
    // Checking if the triangules are congruent.
